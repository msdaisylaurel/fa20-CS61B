...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList ReverseCopyOfA = null;
        IntList AplusB = B;

        do {
            ReverseCopyOfA = new IntList(A.first, ReverseCopyOfA);
            A = A.rest;
        } while(A != null);

        do {
            AplusB = new IntList(ReverseCopyOfA.first, AplusB);
            ReverseCopyOfA = ReverseCopyOfA.rest;
        } while (ReverseCopyOfA != null);
